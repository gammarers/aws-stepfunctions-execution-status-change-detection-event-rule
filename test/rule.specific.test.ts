...
import { StepFunctionsExecutionStatusChangeDetectionEventRule, TargetStatus } from '../src';
...
describe('Default Rule Check', () => {
  ...
  const rule = new StepFunctionsExecutionStatusChangeDetectionEventRule(stack, 'StepFunctionsExecutionStatusChangeDetectionEventRule', {
    ...
    targetStatuses: [TargetStatus.ABORTED, TargetStatus.FAILED, TargetStatus.TIMED_OUT],
  });
